                              ...
                              long mask)
{
   switch (mask){
         case IIO_CHAN_INFO_RAW:
                 switch(chan->channel){
                  case 0: dev_info(&indio_dev->dev, "Trying to write channel (0)"); break;
                  case 1: dev_info(&indio_dev->dev, "Trying to write channel (1)"); break;
                  case 2: dev_info(&indio_dev->dev, "Trying to write channel (2)"); break;
                  case 3: dev_info(&indio_dev->dev, "Trying to write channel (3)"); break;
                  case 4: dev_info(&indio_dev->dev, "Trying to write channel (4)"); break;
                  case 5: dev_info(&indio_dev->dev, "Trying to write channel (5)"); break;
                  default: dev_info(&indio_dev->dev, "Trying to write on non-valid channel (-1)"); break;
                 }
                 return 0;
         default:
                 return -EINVAL;
