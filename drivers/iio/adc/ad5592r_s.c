...
#define AD5592R_S_CNVST_START BIT(0)
#define AD5592R_S_REG_CHAN_HIGH(x) (0x04 + (2 * (x)))
#define AD5592R_S_REG_CHAN_LOW(x) (0x05 + (2 * (x)))
#define AD5592R_S_HIGH_DATA_MSK GENMASK(11, 8)
