 ...
 */
 ...
 static int iio_adc_emu_spi_read(struct iio_adc_emu_st *st, u8 addr, u8 *data)
 {
        ...
        tx = FIELD_PREP(EMU_RDRW_MSK, 1) | addr;
 ...
 static int iio_adc_emu_spi_write(struct iio_adc_emu_st *st, u8 addr, u8 data)
 {
        ...
        tx = FIELD_PREP(EMU_RDRW_MSK, 0) | FIELD_PREP(EMU_ADDR_MSK, addr)
                                ...
                                u16*readval)
{
        ...
        iio_adc_emu_spi_write(st, EMU_REG_CNVST,
                              ...
                              long mask)
{
 ...
 MODULE_DESCRIPTION("Analog Devices IIO-EMU SPI ADC Driver");
