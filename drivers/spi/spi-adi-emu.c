...
static int spi_adi_emu_transfer_one(struct spi_controller *master,
				struct spi_device *spi,
				struct spi_transfer *transfer)
{
	struct spi_adi_emu *emu = spi_controller_get_devdata(master);
...
static int spi_adi_emu_probe(struct platform_device *pdev)
{
	...
	emu = spi_controller_get_devdata(master);
